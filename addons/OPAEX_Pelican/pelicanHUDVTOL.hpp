//defaultUserMFDvalues[] = {0.05, 0.20, 0.10, 1}; //blending Green
//defaultUserMFDvalues[] = {0.3, 0.12, 0.0, 1}; //orange dark
...
class MFD
{
	class AirplaneHUD
	{
		...
		class Draw
		{
			condition = "1-on * on"; //Intentionally unsatisfiable boolean.
			//Intentionally empty
		};
	};
		...
		class Draw
		{
			...
			{//Edited gear text up by 0.04
				...
				class GearText
				{
					...
					align = "left";
					scale = 1;
					pos[] = {{0.932, 0.80}, 1}; //0.84
					right[] = {{0.987, 0.80}, 1}; //0.84
					down[] = {{0.932, 0.845}, 1}; //0.885
				};
				class Glideslope
				{
					clipTL[] = {0, 0};
			...
			{
				type = "group";
				condition = "speed > 29780"; //Orbital velocity eh? //"speed > 185";
				color[] = {1, 0, 0};
				blinkingPattern[] = {0.2, 0.2};
				blinkingStartsOn = 1;
				class SpeedNumber
