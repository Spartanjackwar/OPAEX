...
class CfgPatches
{
 	class OPAEX_Hornet
 	{
		...
		requiredAddons[] = {
			"A3_Weapons_F", "OPAEX_Core", "OPTRE_Core", "OPTRE_Vehicles", "OPTRE_Vehicles_Hornet",
			"OPAEX_AirCore",
		};
 		units[] = {
			"OPAEX_VTOL_Hornet_base", "OPAEX_VTOL_Hornet", "OPAEX_VTOL_Hornet_INS"
		};
 		weapons[] = {};
		magazines[] = {};
		ammo[] = {};
...
class cfgVehicles
{
	...
	class OPAEX_VTOL_Hornet_base: VTOL_Base_F
	{
		...
		class MFD
		{
			class B_Plane_Fighter_01_static_HUD
			{
				...
				class Bones
				{
					...
					//================================================================================
					class ThrustVectoringRotation //START SPARTANJACKWAR EDITS
					{
						type = "rotational";
				...
				class Draw
				{
					...
					class MachineGunCrosshairGroup //edited
					{
						type = "group";
					...
					*/
					...
					class ThrottleNumber
					{
						...
						align = "left";
						scale = 1;
						pos[] = {"PlaneW", {0.4, -0.076}, 1};
						right[] = {"PlaneW", {"0.4 + 0.04", -0.076}, 1};
						down[] = {"PlaneW", {0.4, "-0.076 + 0.05"}, 1};
					};
					class ThrottleText
					{
						type = "text";
						...
						sourceScale = 1;
						align = "right";
						pos[] = {"PlaneW", {0.43, -0.076}, 1};
						right[] = {"PlaneW", {"0.43 + 0.04", -0.076}, 1};
						down[] = {"PlaneW", {0.43, "-0.076 + 0.05"}, 1};
					};
					...
					class Horizont //Contains the limiter!
					{
						clipTL[] = {0.2, 0.2};
						clipBR[] = {0.8, 0.8};
						class Dimmed
		...
		memoryPointsGetInDriver = "pos Driver"; //Assumed previously inherited
		memoryPointsGetInDriverDir = "pos Driver dir"; //Assumed previously inherited
		...
		//================================================================================
		//Armor, simulation, and payload
		armor = 100;
		//weapons[] = {"OPTRE_GUA23A", "OPTRE_missiles_C2GMLS", "CMFlareLauncher", "Laserdesignator_pilotCamera"};
		//magazines[] = {"OPTRE_2000Rnd_20mm_HEIAP", "OPTRE_12Rnd_C2GMLS_missiles", "168Rnd_CMFlare_Chaff_Magazine", "Laserbatteries"};
		weapons[] = {"OPTRE_GUA23A", "CMFlareLauncher", "Laserdesignator_pilotCamera"};
		magazines[] = {"OPTRE_2000Rnd_20mm_HEIAP", "168Rnd_CMFlare_Chaff_Magazine", "Laserbatteries"};
		...
		simulation = "airplanex"; //Critical to enabling the VTOL mode
		...
		//We can get rid of these now since they're in the chain of inheriting.
		/*
		gunAimDown = 0.02; //not sure what this means.
		minGunElev = -2; //Was missing.
		maxGunElev = 2; //Was missing.
		minGunTurn = -2; //Was missing.
		maxGunTurn = 2; //Was missing.
		minGunTurnAI = -2;
		maxGunTurnAI = 2;
		*/
		...
		memoryPointDriverOptics = "Light_L"; //was "slingCamera".  Controls camera position
		unitInfoType = "RscOptics_CAS_Pilot"; //This and the following line displays TGP info
		...
		*/
		...
		//================================================================================
		//Aerodynamics
		#include<HornetAerodynamics.hpp>
		
		//================================================================================
		//User Actions
		driverAction = "pilot_Heli_Light_02"; //driverAction = "pilot_Heli_Light_02";
		driverInAction = "pilot_Heli_Light_02";
		precisegetinout = 1; //was 1
		...
		cargoCanEject = 1;
		driverCanEject = 1; //Since ejector seats require mempoints the hornet isn't rigged for...
		/*
		...
		*/
		...
		class Components
		{
			#include<HornetSensors.hpp>
			class TransportCountermeasuresComponent {};
		};
		#include<HornetDetection.hpp>
		
		//================================================================================
		//Sounds
		soundGetIn[] = {"A3\Sounds_F_Exp\vehicles\air\VTOL_02\TO_getin", 1, 1};
		soundGetOut[] = {"A3\Sounds_F_Exp\vehicles\air\VTOL_02\getout", 1, 1, 40};
		soundDammage[] = {"A3\Sounds_F\vehicles\crashes\cars\cars_coll_big_default_ext_1", 3.16228, 1, 900};
		soundEngineOnInt[] = {"A3\Sounds_F_Exp\vehicles\air\VTOL_02\VTOL_02_start_int", 0.794328, 1};
		soundEngineOnExt[] = {"A3\Sounds_F_Exp\vehicles\air\VTOL_02\VTOL_02_start_ext", 1, 1, 500};
		soundEngineOffInt[] = {"A3\Sounds_F_Exp\vehicles\air\VTOL_02\VTOL_02_stop_int", 0.794328, 1};
		soundEngineOffExt[] = {"A3\Sounds_F_Exp\vehicles\air\VTOL_02\VTOL_02_stop_ext", 1, 1, 500};
		...
		class Sounds
		{
			...
			class TurbineHighInt //edit quieter
			{
				sound[] = {"A3\Sounds_F_Exp\vehicles\air\VTOL_02\VTOL_02_turbine_int", 0.630957, 1, 1800};
				frequency = "1.7 * (rpm factor[-5,1])";
