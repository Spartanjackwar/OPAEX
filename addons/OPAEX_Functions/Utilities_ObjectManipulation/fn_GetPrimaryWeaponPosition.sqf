...
/*
Retrieves the position of the weapon proxy from a unit.  Intended only for infantry use!

Parameter 0: object: object to detect weapon position for.
Parameter 1: 3D array of floats: offset from gun center to use.

Return: ASL position of the unit's weapon proxy.
...
[_unit, "proxy:\a3\characters_f\proxies\weapon.001", _offset] call OPAEX_fnc_GetSelectionPosition;
