...
/*
D20 grenade roll: Spawns a APC hostile to the thrower.
...
switch (_throwerSide) do {
    case west: {_APCSide = east; _APCUnit = "O_APC_Wheeled_02_rcws_v2_F"};
    case east: {_APCSide = west; _APCUnit = "B_APC_Wheeled_01_cannon_F"};
