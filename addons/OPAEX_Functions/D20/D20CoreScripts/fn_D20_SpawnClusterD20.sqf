...
/*
This function spawns a cluster of D20s.

Parameter 0: string: classname of the D20 we spawn.
Parameter 1: string: classname of the magazine we refer to spawn.
Parameter 1: int: number of D20s to spawn
Parameter 2: 3D array: max velocity with which D20s should spawn.
